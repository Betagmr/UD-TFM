...
de los nuevos retos que se presentan. Si bien es cierto que mucha información es
...
documento es exponer el trabajo realizado y servir como referencia a equipos que quieran implementar
...
\begin{itemize}
    ...
    retroceder a versiones anteriores si fuera necesario.
\end{itemize}
...
a través de los sistema cloud que ofrecen servicios MLOps como Azure ML \cite{microsoft2023azureml}, 
...
en la literatura son una mejor supervisión, mejora del proceso de validación, incentivar
...
permite tener un control más en profundidad del mismo.\medskip
...
son más complejos y difíciles de depurar, debido a que muchos de los modelos son en su mayoría
...
\begin{itemize}
    ...
    las prácticas que más impacto tienen en la eficiencia de los modelos son el uso de librerías
    basadas en C \cite{1182968}, la compilación de modelos mediante JIT \cite{Aycock2003Brief}, el empleo de técnicas de cacheo en
    momentos críticos \cite{lruCache}, entre otros. Estas practicas pueden suponer un aumento del doble de la velocidad de
    ejecución en el peor de los casos y un cuádruple término media \cite{Jun2010Comparative}.
    ...
    usuarios finales. Algunas de las practicas recomendables se basan en el uso de librerías de validación como
