...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\textwidth]{crisis-survey.png}
    \caption{Encuesta a 1500 investigador sobre la reproducibilidad en la ciencia}\label{fig:crisis-survey}
\end{figure}
...
\begin{figure}[ht]
    ...
    \caption{Encuesta a 1500 investigador sobre la reproducibilidad en la ciencia}\label{fig:self-reproduce}
\end{figure}
...
\begin{figure}[ht]
    ...
    \caption{Encuesta a 1500 investigador sobre la reproducibilidad en la ciencia}\label{fig:repro-factor}
\end{figure}
