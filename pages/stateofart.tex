...
han sido identificados como problemas clave.\medskip

\begin{figure}[ht]
    \centering
    \includegraphics[width=0.6\textwidth]{crisis-survey.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.55\textwidth]{self-reproduce.png}
...
\subsection{Calidad del software y buenas prácticas}
