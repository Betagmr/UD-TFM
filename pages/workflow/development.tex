...
\begin{itemize}
    \item \textbf{Proyecto 1:} detección de anomalías en el tráfico de coches en una ciudad.
    \item \textbf{Proyecto 2:} 
\end{itemize}
...
para realizar una plantilla de automl enfocada en el forecasting.
...
de probar diferentes modelos de forecasting de manera automática.
...
y siete modelos pero la idea es que en un futuro pueda ser ampliada.
