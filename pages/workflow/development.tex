...
se han realizado dos proyectos para cada una de las dos áreas de
trabajo de las series temporales, \textit{forecasting} y \textit{clasificación}
y \textit{detección de anomalías}.
...
\begin{enumerate}
    ...
    para que otros miembros puedan beneficiarse de los resultados obtenidos. Si
    el no existía una plantilla específica para ese caso de uso 
\end{enumerate}
